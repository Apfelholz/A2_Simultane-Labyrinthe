...
public class SimulanteLabyrintheTest{
    ...
    @Test
    void testMainWithLabyrinthH() {
        String[] output = testMainWithFile("data\\labyrintheH.txt");
        for (String l : output){
            System.out.println(l);
        }
    }
    ...
    @Test
    void testMainWithLabyrinthI() {
        String[] output = testMainWithFile("data\\labyrintheI.txt");
        for (String l : output){
            System.out.println(l);
        }
    }
    ...
    @Test
    void testMainWithLabyrinthJ() {
        String[] output = testMainWithFile("data\\labyrintheJ.txt");
        for (String l : output){
            System.out.println(l);
        }
    }
